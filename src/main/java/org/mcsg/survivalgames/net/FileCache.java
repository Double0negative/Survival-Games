...
public class FileCache {
	...
	public static void loadPage(String pagename, boolean template) {
		...
		Scanner scan = null;
		File f = new File(SurvivalGames.getPluginDataFolder()
				+ (template ? "/www/template.html" : "/www/pages/" + pagename
						+ ".html"));
		...
		try {
			...
			System.out
					.println("Survival Games webstats - Could not load page: "
							+ pagename + "    " + f.getAbsolutePath());
		}
		String data = "";
